...
//#include "rootsystemspatialparamsCRootBox.hh"
...
//SET_TYPE_PROP(RootsystemOnePTwoCTestProblem, SpatialParams, Dumux::CRootBoxRootsystemSpatialParams<TypeTag>);
...
//    return temperatureRoot_; } // 10C
                             ...
                             const GlobalPosition &globalPos ) const
    {
        if (globalPos[2] + eps_ >  this->bBoxMax()[2] )
        {
            ...
            else
            {
                ...
                {
                    if ((this->preSol_[Eid][conti0EqIdx] < criticalCollarPressure ))
                    {
                 ...
                 const int boundaryFaceIdx) const
    {
        ...
        if ( globalPos[2] + eps_ >  this->bBoxMax()[2] )
        {
            ...
            const Scalar rootSurface = spatialParams.rootSurface(element, fvGeometry, scvIdx);
