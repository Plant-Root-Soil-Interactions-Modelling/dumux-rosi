 ...
 */
#ifndef DUMUX_CROOTBOX_ROOTSYSTEM_SPATIAL_PARAMS_DGF_HH
#define DUMUX_CROOTBOX_ROOTSYSTEM_SPATIAL_PARAMS_DGF_HH
...
class CRootBoxRootsystemSpatialParams
{
...
public:
    CRootBoxRootsystemSpatialParams(const GridView &gridView)
        : gridView_(gridView)
    {
    ...
    ~CRootBoxRootsystemSpatialParams()
    {}
    ...
    void setParams()
    {
        ...
        for (const auto& element : elements(gridView_))
        {
            ...
            rootParameter_[elemIdx].resize(9);
            ...
            rootParameter_[elemIdx][Root::radiusIdx] =GridCreator::parameters(level0eIt)[4];
            // root type
            ...
            // root mass
            rootParameter_[elemIdx][Root::massIdx] = GridCreator::parameters(level0eIt)[5];
            // root timeCreated
            rootParameter_[elemIdx][Root::creationTimeIdx] = GridCreator::parameters(level0eIt)[8];
...
private:
    ...
    Scalar Kx_;
    Scalar Kr_;
    Scalar Vmax_, Km_, PartitionCoeff_;
