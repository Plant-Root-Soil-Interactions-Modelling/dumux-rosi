...
//#endif
                      ...
                      const ElementVolumeVariables &elemVolVars) const
    {
        ...
        {
            values[conti0EqIdx] = tree.template get<Scalar>("BoundaryConditions.OuterFluxesWater");
            values[transportEqIdx] = tree.template get<Scalar>("BoundaryConditions.OuterFluxesNutrient");
