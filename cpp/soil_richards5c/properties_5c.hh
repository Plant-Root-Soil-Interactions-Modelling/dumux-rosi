...
#ifndef RICHARDS5C_PROPERTIES_HH
#define RICHARDS5C_PROPERTIES_HH
...
#include <dumux/porousmediumflow/richards5C/model.hh>
...
struct Richards5CBox { using InheritsFrom = std::tuple<RichardsNCTT, BoxModel>; };
struct Richards5CCC { using InheritsFrom = std::tuple<RichardsNCTT, CCTpfaModel>; };
...
struct SpatialParams<TypeTag, TTag::RichardsNCTT> {
    ...
    using type = RichardsParams5C<GetPropType<TypeTag, Properties::GridGeometry>, GetPropType<TypeTag, Properties::Scalar>>;
};
