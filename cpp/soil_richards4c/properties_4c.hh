...
#ifndef RICHARDS4C_PROPERTIES_HH
#define RICHARDS4C_PROPERTIES_HH
...
struct RichardsNCTT { using InheritsFrom = std::tuple<Richards4C>; };
struct Richards4CBox { using InheritsFrom = std::tuple<RichardsNCTT, BoxModel>; };
struct Richards4CCC { using InheritsFrom = std::tuple<RichardsNCTT, CCTpfaModel>; };
...
struct SpatialParams<TypeTag, TTag::RichardsNCTT> {
    ...
    using type = RichardsParams4C<GetPropType<TypeTag, Properties::GridGeometry>, GetPropType<TypeTag, Properties::Scalar>>;
};
