...
#ifndef RICHARDS22C_PROPERTIES_HH
#define RICHARDS22C_PROPERTIES_HH
...
struct RichardsNCTT { using InheritsFrom = std::tuple<Richards22C>; };
struct Richards22CBox { using InheritsFrom = std::tuple<RichardsNCTT, BoxModel>; };
struct Richards22CCC { using InheritsFrom = std::tuple<RichardsNCTT, CCTpfaModel>; };
...
struct SpatialParams<TypeTag, TTag::RichardsNCTT> {
    ...
    using type = RichardsParams22C<GetPropType<TypeTag, Properties::GridGeometry>, GetPropType<TypeTag, Properties::Scalar>>;
};
