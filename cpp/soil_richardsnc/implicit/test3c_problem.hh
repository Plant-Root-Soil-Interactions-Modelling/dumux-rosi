...
/*!
 * \file
 * \ingroup Richards3CTests
 * \brief A water infiltration problem with a low-permeability lens
 *        embedded into a high-permeability domain which uses the
 *        Richards box model.
 */

#ifndef DUMUX_RICHARDS_3C_WELL_TRACER_PROBLEM_HH
#define DUMUX_RICHARDS_3C_WELL_TRACER_PROBLEM_HH
...
#include "test3c_spatialparams.hh"
...
namespace TTag {
struct RichardsWellTracer { using InheritsFrom = std::tuple<Richards3C>; };
 ...
 *
 * This problem uses the \ref Richards3CModel
 *
