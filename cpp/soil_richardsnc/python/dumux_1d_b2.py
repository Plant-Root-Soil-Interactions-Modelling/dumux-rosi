...
p_, z_ = read3D_vtp_data("benchmark1d_2-00000.vtp",2)
h_ = vg.pa2head(p_)
ax1.plot(h_, z_[:,0] * 100, "g+")
p_, z_ = read3D_vtp_data("benchmark1d_2-00001.vtp",2)
h_ = vg.pa2head(p_)
...
c_, z_ = read3D_vtp_data("benchmark1d_2-00000.vtp", 13)
ax2.plot(c_, z_[:,0] * 100, "g:")
c_, z_ = read3D_vtp_data("benchmark1d_2-00001.vtp", 13)
