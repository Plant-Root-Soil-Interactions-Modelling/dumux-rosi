#ifndef PYTHON_RICHARDS22C_CYL_H_
#define PYTHON_RICHARDS22C_CYL_H_
...
#include "richards22_cyl.hh" // includes solverbase
...
#include <dumux/porousmediumflow/richards22c/model.hh>
...
struct RichardsTT { using InheritsFrom = std::tuple<Richards22C>; }; // defaults,  <dumux/porousmediumflow/richardsCylindrical1d/model.hh>
...
struct Problem<TypeTag, TTag::RichardsTT> { using type = Richards1P22CProblem<TypeTag>; };
...
using RichardsNCCylFoamProblem = Dumux::Richards1P22CProblem<RNCCFoamTT>;


PYBIND11_MODULE(rosi_richards22c_cyl, m) {
    ...
    init_richards_22cyl<RichardsNCCylFoamProblem, RichardsNCCylFoamAssembler, RichardsNCCylFoamLinearSolver, 1 /*dimension*/>(m, "RichardsNCCylFoam");
}
