#ifndef PYTHON_RICHARDS5C_H_
#define PYTHON_RICHARDS5C_H_
...
#include "richards5.hh" // includes in solverbase

#include "../soil_richards5c/richards1p5cproblem.hh" // the problem class
...
#include <dumux/porousmediumflow/richards5c/model.hh> // the model
...
struct RichardsNCTT { using InheritsFrom = std::tuple<Richards5C>; }; // defaults, dumux/porousmediumflow/richards/model.hh
...
using RichardsNCSPProblem = Dumux::Richards1P5CProblem<RNCSPTT>;


PYBIND11_MODULE(rosi_richards5c, m) {
    init_solverbase<RichardsNCSPProblem, RichardsSPAssembler, RichardsSPLinearSolver>(m, "BaseRichards5CSP");
    init_richards_5<RichardsNCSPProblem, RichardsSPAssembler, RichardsSPLinearSolver>(m, "Richards5CSP");

	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPLinearSolverNum>(m, "BaseRichards5CSPnum");
    init_richards_5<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPLinearSolverNum>(m, "Richards5CSPnum");
	
	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPSeqLinearSolver>(m, "BaseRichards5CSPSeq");
    init_richards_5<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPSeqLinearSolver>(m, "Richards5CSPSeq");
	...
	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPILURestartedGMResIstlLinearSolver>(m, "BaseRichards5CSPILURes");
    init_richards_5<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPILURestartedGMResIstlLinearSolver>(m, "Richards5CSPILURes");
}
