#ifndef PYTHON_RICHARDS_4CYL_SOLVER_H_
#define PYTHON_RICHARDS_4CYL_SOLVER_H_
...
class Richards4Cyl : public RichardsCyl<Problem, Assembler, LinearSolver, dim> 
{
	public:

    using NumEqVector = typename Problem::NumEqVector;
    virtual ~Richards4Cyl() { }
	 /**
 ...
 */
template<class Problem, class Assembler, class LinearSolver, int dim = 1>
void init_richards_4cyl(py::module &m, std::string name) {
    using RichardsFoam = Richards4Cyl<Problem, Assembler, LinearSolver>;
