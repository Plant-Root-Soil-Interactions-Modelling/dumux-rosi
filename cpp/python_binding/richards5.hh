#ifndef PYTHON_RICHARDS5_SOLVER_H_
#define PYTHON_RICHARDS5_SOLVER_H_
...
class Richards5 : public Richards<Problem, Assembler, LinearSolver, dim> {
public:
...
void init_richards_5(py::module &m, std::string name) {
    using Richards_ = Richards5<Problem, Assembler, LinearSolver>;
