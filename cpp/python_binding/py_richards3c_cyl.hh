...
#include "../soil_richardsnc/richards1p3cproblemReaction_cyl.hh" // the problem class
...
#include <dumux/porousmediumflow/richards3cCylindrical1d/model.hh>
...
struct RichardsTT { using InheritsFrom = std::tuple<Richards3C>; }; // defaults,  <dumux/porousmediumflow/richardsCylindrical1d/model.hh>
...
struct Problem<TypeTag, TTag::RichardsTT> { using type = Richards1P3CProblem<TypeTag>; };
...
using RichardsCylFoamProblem = Dumux::Richards1P3CProblem<RCFoamTT>;


PYBIND11_MODULE(rosi_richards3c_cyl, m) {
    init_solverbase<RichardsCylFoamProblem, RichardsCylFoamAssembler, RichardsCylFoamLinearSolver, 1 /*dimension*/>(m, "BaseRichards3CCylFoam");
    init_richards_cyl<RichardsCylFoamProblem, RichardsCylFoamAssembler, RichardsCylFoamLinearSolver, 1 /*dimension*/>(m, "Richards3CCylFoam");
}
