#ifndef PYTHON_RICHARDS22_SOLVER_H_
#define PYTHON_RICHARDS22_SOLVER_H_
...
class Richards22 : public Richards<Problem, Assembler, LinearSolver, dim> {
public:
...
void init_richards_22(py::module &m, std::string name) {
    using Richards_ = Richards22<Problem, Assembler, LinearSolver>;
