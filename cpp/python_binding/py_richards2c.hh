...
PYBIND11_MODULE(rosi_richards2c, m) {
    init_solverbase<RichardsNCSPProblem, RichardsNCSPAssembler, RichardsNCSPLinearSolver>(m, "BaseRichards2CSP");
    init_richards<RichardsNCSPProblem, RichardsNCSPAssembler, RichardsNCSPLinearSolver>(m, "Richards2CSP");
}
