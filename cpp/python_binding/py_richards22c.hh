#ifndef PYTHON_RICHARDS22C_H_
#define PYTHON_RICHARDS22C_H_
...
#include "richards22.hh" // includes in solverbase

#include "../soil_richards22c/richards1p22cproblem.hh" // the problem class
...
#include <dumux/porousmediumflow/richards22c/model.hh> // the model
...
struct RichardsNCTT { using InheritsFrom = std::tuple<Richards22C>; }; // defaults, dumux/porousmediumflow/richards/model.hh
...
struct Problem<TypeTag, TTag::RichardsNCTT> { using type = Richards1P22CProblem<TypeTag>; };
...
using RichardsNCSPProblem = Dumux::Richards1P22CProblem<RNCSPTT>;


PYBIND11_MODULE(rosi_richards22c, m) {
    init_solverbase<RichardsNCSPProblem, RichardsSPAssembler, RichardsSPLinearSolver>(m, "BaseRichardsNCSP");
    init_richards_22<RichardsNCSPProblem, RichardsSPAssembler, RichardsSPLinearSolver>(m, "RichardsNCSP");

	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPLinearSolverNum>(m, "BaseRichardsNCSPnum");
    init_richards_22<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPLinearSolverNum>(m, "RichardsNCSPnum");
	
	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPSeqLinearSolver>(m, "BaseRichardsNCSPSeq");
    init_richards_22<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPSeqLinearSolver>(m, "RichardsNCSPSeq");
	
	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsILUIstlLinearSolver>(m, "BaseRichardsNCSPILU");
    init_richards_22<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsILUIstlLinearSolver>(m, "RichardsNCSPILU");
	
	init_solverbase<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPSSORCGIstlLinearSolver>(m, "BaseRichardsNCSPSSORC");
    init_richards_22<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPSSORCGIstlLinearSolver>(m, "RichardsNCSPSSORC");
    ...
    init_richards_22<RichardsNCSPProblem, RichardsSPAssemblerNum, RichardsSPILURestartedGMResIstlLinearSolver>(m, "RichardsNCSPILURes");
}
