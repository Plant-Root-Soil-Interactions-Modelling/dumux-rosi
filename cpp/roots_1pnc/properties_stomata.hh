...
public:
    using type = CCTpfaGridGeometry<GridView, enableCache, CCTpfaDefaultGridGeometryTraits<GridView, MapperTraits>>;
};
...
struct SpatialParams<TypeTag, TTag::RootsOnePTwoC> {
    using GridGeometry = GetPropType<TypeTag, Properties::GridGeometry>;
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
    using type = RootSpatialParamsRB<GridGeometry, Scalar>; // TODO
};
int simtype = rootbox;
#endif
