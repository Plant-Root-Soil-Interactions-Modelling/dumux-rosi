...
t0 = time.time()
threads_ = []
threads_.append(myThread("./coupled input/swbot.input -RootSystem.Grid.File grids/RootSys/Reference/RootSys1.dgf -Problem.Name swbot_a"))
threads_.append(myThread("./coupled input/swbot.input -RootSystem.Grid.File grids/RootSys/Genotype_laterals/RootSys1.dgf -Problem.Name swbot_b"))
threads_.append(myThread("./coupled input/swbot.input -RootSystem.Grid.File grids/RootSys/Genotype_volume/RootSys1.dgf -Problem.Name swbot_c"))
...
# Read results
with open("swbot_a_actual_transpiration.txt", 'r') as f:
