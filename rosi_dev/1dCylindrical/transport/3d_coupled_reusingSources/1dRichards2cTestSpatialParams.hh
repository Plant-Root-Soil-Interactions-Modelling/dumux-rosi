 ...
 */
#ifndef DUMUX_RICHARDS_BUFFER_RADIALLY_SYMMETRIC_TEST_SPATIAL_PARAMETERS_HH
#define DUMUX_RICHARDS_BUFFER_RADIALLY_SYMMETRIC_TEST_SPATIAL_PARAMETERS_HH
...
public:
        ...
        : ParentType(gridView)
    {
        ...
        permeability_ = tree.template get<Scalar>("SpatialParams.Permeability");
        porosity_ = tree.template get<Scalar>("SpatialParams.Porosity");
        Swr_ = tree.template get<Scalar>("materialParams.Swr");
        VgAlpha_ = tree.template get<Scalar>("materialParams.VgAlpha");
        Vgn_ = tree.template get<Scalar>("materialParams.Vgn");
        buffer_ = tree.template get<Scalar>("SpatialParams.BufferPower");
