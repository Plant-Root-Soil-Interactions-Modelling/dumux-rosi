...
Transfinite Line{5,6,7,8} = Ceil(2) Using Progression 1;
Transfinite Line{1,2,3,4} = Ceil(10) Using Progression 1;
Transfinite Line{-9,-10,-11,-12} = Ceil(20) Using Progression 1.2;
