...
approach = "11-08-2021_CStudy_classic_sink_"

# KOMMA!!!!!!!!!!!!!!!!!!!!!!! "CStudy_loam_dry_4,0cm"
name = "WCT_loam_dry_0,6cm"


#name = "CStudy_loam_wet_0,cm"

dirname= approach +name
cell_number = [13, 13, 25]  # [8, 8, 15]  # [8, 8, 15]  # [16, 16, 30]  # [32, 32, 60]  # [8, 8, 15]
