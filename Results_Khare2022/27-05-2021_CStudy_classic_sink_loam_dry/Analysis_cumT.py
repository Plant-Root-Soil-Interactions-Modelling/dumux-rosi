...
col = ["r--", "tab:pink", "tab:orange",  "tab:gray", "b", "m-", "c", "y", "g", "g-"]
#os.walk('cumT_plots/.')
...
plt.tight_layout()
plt.savefig('sand_dry_Tact.png', dpi=300, bbox_inches = "tight")
print(l)
#plt.show()
...
plt.tight_layout()
plt.savefig('sand_dry_CumT.png', dpi=300, bbox_inches = "tight")
plt.show()
