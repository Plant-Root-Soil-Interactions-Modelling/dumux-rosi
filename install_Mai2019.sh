...
\cp rosi/dumux/_/common/timemanager.hh dumux/dumux/common/
\cp rosi/dumux/_/implicit/model.hh dumux/dumux/implicit/
\cp rosi/dumux/_/implicit/problem.hh dumux/dumux/implicit/
\cp rosi/dumux/_/io/gridcreator.hh dumux/dumux/io/
\cp rosi/dumux/_/io/restart.hh dumux/dumux/io/
...
# run build
## TODO: UPDATE LINK
./dune-common/bin/dunecontrol --opts=./dumux-rosi/optim.opts --builddir=$(pwd)/pubMai2019  all
#
if [ $? -ne 0 ]; then
    echo "*********************************************************************************************"
