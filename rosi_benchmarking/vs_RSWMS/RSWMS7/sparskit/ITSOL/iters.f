...
c      print*,'ipar(3)',ipar(3),'fpar(3) -> ini residual',fpar(3)
c      print*,'fpar(1)=relative error',fpar(1),'fpar(2)=absolute',fpar(2)
c      print*,'alpha',sx
...
c
c      print*,'fpar(4) = target norm',fpar(4)
c      print*,'fpar(6) = norm',fpar(6)
