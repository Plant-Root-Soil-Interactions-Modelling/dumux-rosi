...
# Format of txt file:
# time_, lastActualTrans_, lastTrans_, lastMaxTrans_, (p - pRef_) * 100 / rho_ / g_, trans
# 0    , 1               , 2         , 3            , 4                            , 5
#
...
mid1 = round(d.shape[0] / 2)
mid2 = round(d2.shape[0] / 2)
mid3 = round(d3.shape[0] / 2)
print("transpiration during stress", d[mid1, 1], "kg/s at", d[mid1, 4], "cm, max trans", d[mid1, 3])
print("transpiration during stress", d2[mid2, 1], "kg/s at", d2[mid2, 4], "cm, max trans", d2[mid2, 3])
print("transpiration during stress", d3[mid3, 1], "kg/s at", d3[mid3, 4], "cm, max trans", d3[mid3, 3])
p = d[mid1, 4] + 10000
print(p)
