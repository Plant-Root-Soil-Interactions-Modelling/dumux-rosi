...
if __name__ == "__main__":
    ...
    # create grid for benchmark 1
    L = 0.25  # length of single straight root (m)
    nnz = 25 # 200 causes problems..., 50 maybe too...
    ...
    age = np.zeros((1, nnz))
    kr_ = np.ones((1, nnz)) * 1.8e-5  # 2.e-9;
    kz_ = np.ones((1, nnz)) * 4.3;
    params = np.vstack((order, a_, kz_, kr_, a_,  age, age, age))
