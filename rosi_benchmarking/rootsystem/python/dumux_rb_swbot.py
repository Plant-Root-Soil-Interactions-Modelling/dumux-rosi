...
p1 = "-RootSystem.Grid.InitialT 10 -RootSystem.Grid.File Anagallis_femina_Leitner_2010"  # 63.5 File maize_p1_zero_std
...
ax1.plot(t, d2[:, 1] * c, 'g-,')  # lateral
ax1.plot(t, d2[:, 3] * c, 'g:')  # lateral
ax1.plot(t, d3[:, 1] * c, 'b-,')  # volume
ax1.plot(t, d3[:, 3] * c, 'b:')  # volume
