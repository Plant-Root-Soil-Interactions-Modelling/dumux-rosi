...
s.setHomogeneousIC(-659.8, True)  # cm pressure head, equilibrium
s.setTopBC("noFlux")
s.setBotBC("noFlux")
...
s.writeDumuxVTK("convergence_final")

""" Plot """
if rank == 0:
    print ("Convergence problem solved in ", timeit.default_timer() - start_time, " s")
    ...
    ax1.set_ylabel("Transpiration $[mL d^{-1}]$")
