function rosiroot00001 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ROSIROOT00001 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   ROSIROOT00001 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   rosiroot00001 = importfile('rosi-root-00001.vtp', 2502, 2646);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/10/06 08:01:17
...
rosiroot00001 = [dataArray{1:end-1}];
