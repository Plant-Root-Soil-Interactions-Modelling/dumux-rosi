function rosisoil00000 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ROSISOIL00000 = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   ROSISOIL00000 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   rosisoil00000 = importfile('rosi-soil-00000.vtu', 7366, 8032);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/09/29 13:22:06
...
rosisoil00000 = [dataArray{1:end-1}];
