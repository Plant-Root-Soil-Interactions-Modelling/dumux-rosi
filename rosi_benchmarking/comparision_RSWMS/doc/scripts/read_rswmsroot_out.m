function [VarName1,leVersion,VarName3,VarName4] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [VARNAME1,LEVERSION,VARNAME3,VARNAME4] = IMPORTFILE(FILENAME) Reads
%   data from text file FILENAME for the default selection.
%
%   [VARNAME1,LEVERSION,VARNAME3,VARNAME4] = IMPORTFILE(FILENAME, STARTROW,
%   ENDROW) Reads data from rows STARTROW through ENDROW of text file
%   FILENAME.
%
% Example:
%   [VarName1,leVersion,VarName3,VarName4] =
%   importfile('outRoot01.2.vtk',8992, 10786);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/10/06 08:09:33
...
leVersion = cell2mat(rawNumericColumns(:, 2));
