...
#include "../soil_richardsnc/richardsncparams.hh"
...
template<class TypeTag>
struct Grid<TypeTag, TTag::RichardsWellTracer> { using type = GRIDTYPE; };
...
struct SpatialParams<TypeTag, TTag::RichardsWellTracer>
{
    ...
    using type = RichardsParams<FVGridGeometry, Scalar>;
};
...
//        const auto& e = Dune::elements(fvGridGeometry->gridView()).begin(); // first element
//        pcTop_ = MaterialLaw::pc(this->spatialParams().materialLawParams(e), sw);
        pcTop_ = 1.e5;
