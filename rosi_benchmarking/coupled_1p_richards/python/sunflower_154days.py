''' Run sunflower_154days periodic '''
...
# run simulation
os.system("./coupled_periodic input/sunflower_154days_HLCT.input")
...
with open("sunflower_154days_HLCT_actual_transpiration.txt", 'r') as f:  # benchmarkC12c_actual_transpiration. or benchmarkC12bc_actual_transpiration
