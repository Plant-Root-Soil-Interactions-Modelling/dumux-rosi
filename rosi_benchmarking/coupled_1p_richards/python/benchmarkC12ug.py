...
# run simulation
os.system("./coupledUG input/benchmarkC12ug.input")  # benchmarkC12, or benchmarkC12b
...
with open("benchmarkC12cug_actual_transpiration.txt", 'r') as f:  # benchmarkC12c_actual_transpiration. or benchmarkC12bc_actual_transpiration
