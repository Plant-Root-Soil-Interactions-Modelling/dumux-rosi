...
# run simulation
os.system("./coupled_periodic input/sunflower_14days_HLCT.input")
...
with open("sunflower_14days_HLCT_actual_transpiration.txt", 'r') as f:  # benchmarkC12c_actual_transpiration. or benchmarkC12bc_actual_transpiration
