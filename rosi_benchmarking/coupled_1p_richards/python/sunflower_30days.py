...
# run simulation
os.system("./coupled_periodic input/sunflower_30days_HLCT.input")
...
with open("sunflower_30days_HLCT_actual_transpiration.txt", 'r') as f:  # benchmarkC12c_actual_transpiration. or benchmarkC12bc_actual_transpiration
