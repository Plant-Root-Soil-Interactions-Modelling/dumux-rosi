...
// both Box                  properties.hh // <- not working for Alugrid unstructured grid
// both CCTpfa               propertiesCC.hh // <- working, but bad results for Alugrid unstructured grid
// box soil, CC roots,       propertiesMix.hh (CC roots needed for periodicity) // <- not working for Alugrid unstructured grid
// change L70 & L71 accordingly
