...
public:
        ...
        : gridView_(gridView)
    {
        ...
        //RootSystemAge_ = GET_RUNTIME_PARAM(TypeTag, Scalar, SpatialParams.RootSystemAge);
    }
    ...
    void setParams()
    {
        ...
        for (const auto& element : elements(gridView_))
        {
            ...
            //Scalar rootLength = GridCreator::parameters(level0eIt)[3];
            ...
            // root surface
            rootParameter_[elemIdx][Root::surfaceIdx] = GridCreator::parameters(level0eIt)[2];
            // root mass
