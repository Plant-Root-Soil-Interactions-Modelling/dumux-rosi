...
if rank == 0:
    ...
    ana.write("results/RootSys.vtp")
    vp.write_soil("results/Soil", s, min_b, max_b, cell_number, ["C concentration [g/cm³]"])


    #scenario.write_files("maize_cyl0", psi_x_, psi_s_, sink_, x_, y_, psi_s2_, soil_c_, c_)
    scenario.write_files("maize_cyl3", psi_x_, psi_s_, sink_, x_, y_, psi_s2_, 0, 0, 0, 0, soil_c_, c_)
