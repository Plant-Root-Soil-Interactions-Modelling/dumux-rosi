...
s.setParameter("Soil.C_S_W_thresC", str(0.01 * 100 )) #mol/cm3
s.setParameter("Soil.C_S_W_thresO", str(0.001 * 100 )) #mol/cm3
...
COd = 0.1 /2 * 1e6 *0#mol C / m3 space
...
CCd = 0.1 /2 * 1e6 *0#mol C / m3 space
