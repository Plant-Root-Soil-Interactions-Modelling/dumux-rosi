...
exud = 0.01* MolarMass *1000# [mol/cm2/d] * [kg/mol] * [g/kg] =  [g/m2/d]
s.setParameter( "BC.Bot.C1Value", str(0))#exud )) 
...
#s.setParameter("Soil.IC.C1", "0.0002 0.0003 0.0004 0.0005 0.006") 
...
write_file_array("solute_conc", np.array(s.getSolution_(1)).flatten()/( MolarMass *1000)) 
