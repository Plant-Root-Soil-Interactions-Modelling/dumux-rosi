...
solute_mC = s.getSolution_(1).flatten() # [g/cm3]
solute_mol = solute_mC / MolarMass_g # [g/cm3] * [mol/g] = [mol/cm3]
write_file_array("solute_conc_mol", solute_mol ) #[mol/cm3 water]
write_file_array("solute_conc_g", solute_mC ) #[g/cm3 water] == [g/g water]
#raise Exception
for i, dt in enumerate(np.diff(times)):
    ...
    solute_mol = solute_mC / MolarMass_g # [g/cm3] * [mol/g] = [mol/cm3]
    write_file_array("solute_conc_mol", solute_mol ) #[mol/cm3 water]
    write_file_array("solute_conc_g", solute_mC ) #[mol/cm3 water]
