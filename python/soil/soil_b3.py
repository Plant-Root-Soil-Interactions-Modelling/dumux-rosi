...
def solve(soil, simtimes):
    ...
    s.initialize()
    s.setTopBC("atmospheric", 0.5, [[-1.0, 1.0e10], [100.0, 100.0]])  #  [cm/day] atmospheric is with surface run-off
    s.setBotBC("freeDrainage")
    N = 199
    s.createGrid([-5.0, -5.0, -200.0], [5.0, 5.0, 0.0], [1, 1, N])  # [cm] N
    s.setHomogeneousIC(-400.0)  # cm pressure head
...
if __name__ == "__main__":
    ...
    xa, za = solve(sand, [0.0, 0.1, 0.2, 0.3])
    xb, zb = solve(loam, [0.0, 0.2, 0.5, 1.0])
    xc, zc = solve(clay, [0.0, 0.1, 0.2, 0.5])
