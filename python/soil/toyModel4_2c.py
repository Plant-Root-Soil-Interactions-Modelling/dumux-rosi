...
# from rosi.rosi_richards10c import Richards10CSP  # C++ part (Dumux binding)
...
s.setHomogeneousIC(-100.0)  # cm pressure head
...
molarMassWat = 18.0  # [g/mol]
densityWat = 1.0  # [g/cm3]
# [mol/cm3] = [g/cm3] /  [g/mol]
...
bulkDensity_m3 = solidMolDensity * (1.0 - 0.43)

MolarMass = 1.8e-2  # [kg/mol] 0.02003 #[kg/mol]
exud = 1.0 * 0  # [mol/cm2/d]#1.0* MolarMass *1000# [mol/cm2/d] * [kg/mol] * [g/kg] =  [g/cm2/d]
Ds = 1e-8 * 0  # m^2/s
Dl = 1e-9 * 0
...
times = [0.0, 5.0 / 24.0 / 3600, 10.0 / 24.0 / 3600]  # days
s.ddt = 1.0e-5
