...
import figure_style
from richards import RichardsWrapper  # Python part |\label{l61:paths_a}|
from rosi_richards import RichardsSP  # C++ part (Dumux binding) |\label{paths_e}|
...
s.setTopBC("constantFlux",evap ) #  (cm day-1) atmospheric is with surface run-off   |\label{l61:top_bc}|
