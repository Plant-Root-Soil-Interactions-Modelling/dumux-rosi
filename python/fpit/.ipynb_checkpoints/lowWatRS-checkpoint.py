...
results_dir="./results/lowWaterRS"+str(max_rank)+"/"
...
rs, r = scenario.create_mapped_plant(wilting_point, nc, logbase, mode,initsim,
                                        ...
                                        path, plantType = plantType_, 
                                        recreateComsol_ = recreateComsol,
                                        usemoles = usemoles,
                                        limErr1d3d = 1e-13*100)  # pass parameter file for dynamic growth
...
while rs_age < simMax: #for i, dt in enumerate(np.diff(times)):
    ...
    net_sol_flux, net_flux = cyl3.simulate_const(s, 
                                            ...
                                            results_dir = results_dir,plantType = plantType_)
