...
class fixedPointIterationHelper():
    ...
    def compute1dChangesSolute(self, dt):
        ...
        if rank == 0:
            ...
            print('sources_CN_from1d',sources_CN_from1d[6]*dt)
            print('PminNU_limited',PminNU_limited.sum()*dt)
            ...
            print('self.s.errSoil_source_CN_abs',self.s.errSoil_source_CN_abs*dt)
            ...
            if rank == 0:
                ...
                if (max(abs(SSL)) != 0.):
                    ...
                    try:
                        ...
                        raise Exception
                    print('sendSource2dumux', SSL*dt, idComp) 
