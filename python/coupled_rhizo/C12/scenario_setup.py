...
def set_scenario(dimension, age_dependent = False):
    ...
    soil = loam
    sra_table_lookup = open_sra_lookup("../../coupled/table_loam")
    ...
    """ root hydraulic model & rhizosphere models"""
    mode = "dumux"  # "dumux"or "dumux_exact"
    NC = 10  # dof+1
    ...
    # print("r", type(r))
    # print("r.rs", type(r.rs))

    return r, rs, rs_age, trans, wilting_point, soil, s, sra_table_lookup, mapping, sim_time, dt, skip
