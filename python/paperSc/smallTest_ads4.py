...
stf.setIC(s, -103.25, paramIdx)

s.QCflowOut =np.array([ -5.136688687529069e-06 ,-2.910181366106239e-12]  )
s.QflowOut = 0.0021181155032084916
s.win = 0.
s.exuds_in = 0.
s.exudl_in = 0.
...
#go together
s.setParameter("Newton.MaxAbsoluteResidual", "1.e-8")
s.setParameter("Newton.EnableAbsoluteResidualCriterion", "true")

#go together
s.setParameter("Newton.ResidualReduction", "1e-8")
...
times = np.array([0.,0.013888888888888888,0.013888888888888888*2.,
                 0.013888888888888888*3.,0.013888888888888888*4.] ) # days
