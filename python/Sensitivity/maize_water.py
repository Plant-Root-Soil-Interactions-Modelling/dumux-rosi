...
theta_s = 0.403
alpha = 0.0383  # (cm-1) soil95
n = 1.3774
k_sat = 60.  # (cm d-1)
soil_ = [theta_r, theta_s, alpha, n, k_sat]

trans = 0.6 * (75 * 15)  # cm3/day (75 * 15 = 1125 cm2)
...
trans_f1 = lambda age, dt:-trans * sinusoidal2(age, dt)  # Guilaumes questions
...
if rank == 0:
    ...
    scenario.write_files("maize_sra2", psi_x_, psi_s_, sink_, x_, y_, psi_s2_)
