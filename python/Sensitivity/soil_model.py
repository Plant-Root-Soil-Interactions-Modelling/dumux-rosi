...
def create_richards(soil_, min_b, max_b, cell_number, times=None, net_inf=None, bot_bc="noFlux", bot_value=0.0, initial_totalpotential=-100):
    """
...
def plot_solution1D(s, depth=-200):
    ...
    h = s.getSolutionHead()
    plt.plot(h, np.linspace(-200.0, 0.0, h.shape[0]))
