...
def init_lupine_conductivities_sa(r, ykr1, okr1, ykr2, okr2, kr3_, ykx1, okx1, ykx2, okx2, kx3_):
    ...
    r.set_kr_age([0.], [0.], 0) # artificial shoot
    r.set_kx_age([0.], [1.e3], 0)
    ...
    r.set_kr_age(kr1[:, 0], kr1[:,1], [1,4,5]), # age, value, subType
    r.set_kx_age(kx1[:, 0], kx1[:,1], [1,4,5])
    r.set_kr_age(kr2[:, 0], kr2[:,1], 2)
    r.set_kx_age(kx2[:, 0], kx2[:,1], 2)
    r.set_kr_age(kr3[:, 0], kr3[:,1], 3)    
    r.set_kx_age(kx3[:, 0], kx3[:,1], 3)
...
def init_lupine_conductivities(r, skr = 1., skx = 1.):
    ...
    r.set_kr_age(kr0[:, 0], kr01, [1,4,5]), # age, value, subType
    r.set_kx_age(kx0[:, 0], kx01, [1,4,5])
    r.set_kr_age(kr1[:, 0], kr11, [2,3])
    r.set_kx_age(kx1[:, 0], kx11, [2,3])
