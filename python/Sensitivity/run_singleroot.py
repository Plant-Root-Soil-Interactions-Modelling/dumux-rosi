...
if __name__ == "__main__":
    ...
    # run_soybean("test2", enviro_type, sim_time, kr, kx, [1., 1., 1.], theta1, [1., 1.], 1., src, kr_old, kx_old, save_all = True)

    run_soybean("test1", enviro_type, sim_time, 1., 1., [1., 1., 1.], theta1, [1., 1.], 1., src, save_all = True)
