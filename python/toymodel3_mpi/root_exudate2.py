...
while rs_age < simMax: #for i, dt in enumerate(np.diff(times)):
    ...
    Q_Mucil_i     = (Q_Mucil   - Q_Mucilbu)*inflateVal*1e6
    ...
    write_file_array("errors1ds3ds", np.array([rs.sumDiff1d3dCW_abs, rs.sumDiff1d3dCW_rel,
                                        rs.maxDiff1d3dCW_abs, rs.maxDiff1d3dCW_rel]), directory_ =results_dir)# cumulative (?)
