...
""" 
Jan's new scenario with the new SRA sink
"""
...
for i in range(0, NT):
    ...
    if rank == 0:  # root part is not parallel
        ...
        while err > 1. and c < 100:
            ...
            rsx = soil_root_interface_table(rx[1:], hsb, inner_, outer_, sra_table_lookup)
            # rsx = soil_root_interface(rx[1:], hsb, inner_, outer_, r, soil, rs_age + t)
