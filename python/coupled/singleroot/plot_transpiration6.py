...
# # Constant scenarios
# names_dry = ["results/transpiration_singleroot_cyl_constkrkx_dry",
#              "results/transpiration_singleroot_sra_constkrkx_dry",
#              "results/transpiration_singleroot_agg_constkrkx_dry"]
# names_wet = ["results/transpiration_singleroot_cyl_constkrkx_wet",
#              "results/transpiration_singleroot_sra_constkrkx_wet",
#              "results/transpiration_singleroot_agg_constkrkx_wet"]
# trans = 0  # cm3/day

# Dynamic scenarios
names_dry = ["results/transpiration_singleroot_cyl_dynamic_constkrkx_dry",
             "results/transpiration_singleroot_sra_dynamic_constkrkx_dry",
             "results/transpiration_singleroot_agg_dynamic_constkrkx_dry"]
names_wet = ["results/transpiration_singleroot_cyl_dynamic_constkrkx_wet",
             "results/transpiration_singleroot_sra_dynamic_constkrkx_wet",
             "results/transpiration_singleroot_agg_dynamic_constkrkx_wet"]
trans = 0.5  # cm3/day
