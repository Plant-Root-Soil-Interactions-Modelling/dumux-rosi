...
#"maxTil" ,"firstTil","delayTil" ,"maxB"
    ...
    namesVars_xyl = ["maxTil","maxB", "a",
                     "lmaxr", "rr", "lnr", 
                     "lmaxst", "rst", "lnst", #"ast",
                     "lmaxl", "rl", "Width_blade",        #+13 -6
                     'k_fw1','psi_t,crit,1',              #'oi', 'Chl','fw1r',
                     'kchl', 'kg1','kjmax', 'alpha',         #'kchl1', 'kchl2',
                     'omega', 'gm', 'k_x'] #, "l_kr",'kr_x'
    namesLim_xyl = [[0.5,2],[0.5,2],[0.5,2],
                     [0.5,2],[0.5,2],[0.5,2],#[0.5,2],
                     [0.5,2],[0.5,2],[0.5,2],#[0.5,2],
                     [0.5,2],[0.5,2],[0.5,2],
                     [0.5,2],[0.5,2],                      #[0.5,2],[0.5,2],[0.5,2],
                     [0.5,2],[0.5,2],[0.5,2],[0.02/0.4,0.95/0.4], #[0.5,2],
