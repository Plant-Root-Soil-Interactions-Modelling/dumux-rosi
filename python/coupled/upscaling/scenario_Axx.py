...
if __name__ == "__main__":
    ...
    # rs, pname:str, rp, s, periodic:bool, min_b, max_b, cell_number, filename:str = "", sol_ind = 0, interactiveImage = True
    # max_b[2] *= 0.5
    vp.plot_roots_and_soil(ana, "subType", None, s, True, min_b, max_b, cell_number, filename = args.plant + "_" + args.dim)
