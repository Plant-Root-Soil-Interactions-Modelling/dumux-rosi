...
if __name__ == "__main__":
    ...
    args = parser.parse_args(['soybean', "1D", "hydrus_clay", "surface"])
    ...
    print("sx", sx.shape)
    print("hs", hs.shape)
    r.segFluxes(simTime, rx, sx, false, false)
