...
for i in range(0, NT + 1):
    ...
    rx = r.solve_dirichlet(rs_age + t, [-8000.], 0., rsx, cells = False, soil_k = [])
    proposed_inner_fluxes = r.segFluxes(rs_age + t, rx, rsx, approx = True, cells = False, soil_k = [])  # [cm3/day]
...
if rank == 0:
    ...
    print(np.transpose(np.array(psi_x_)))
