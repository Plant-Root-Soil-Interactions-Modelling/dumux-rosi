...
names_dry = ["results/transpiration_singleroot_cyl_dynamic_constkrkx_dry", "results/transpiration_singleroot_sra_dynamic_constkrkx_dry", "results/transpiration_singleroot_sra_dynamicA2_constkrkx_dry"]
names_wet = ["results/transpiration_singleroot_cyl_dynamic_constkrkx_wet", "results/transpiration_singleroot_sra_dynamic_constkrkx_wet", "results/transpiration_singleroot_sra_dynamicA2_constkrkx_wet"]
...
# load data
data_dry = [np.loadtxt(n, delimiter=';')  for n in names_dry]
data_wet = [np.loadtxt(n, delimiter=';')  for n in names_wet]
...
for i in range(0, n):
    ...
    ax[i][0].set_title(names_wet[i])
    ax[i][0].set_ylabel("Transpiration [cm$^3$ d$^{-1}$]")
    ...
    # ax[i].set_xlabel("Time [d]")
    ax[i][1].set_title(names_dry[i])
    ax[i][1].set_ylabel("Transpiration [cm$^3$ d$^{-1}$]")
    # ax[i].set_ylim([0., 1150.])
