...
def setKrKx_xylem(TairC, RH,r,DictVal): #inC
    ...
    kr_l  = 3.83e-5 * hPa2cm * DictVal['kr_x']
...
def setDefaultVals(r,weatherX,DictVal):
    ...
    r.setRmax_st([[14.4 * DictVal['rmax'],9.0 * DictVal['rmax'],6.0 * DictVal['rmax'],14.4 * DictVal['rmax']],[5. * DictVal['rmax'],5. * DictVal['rmax']],[15. * DictVal['rmax']]])
    ...
    r.maxLoop = 10000
    r.minLoop=900
    r.k_S_ST = 5/24 * DictVal['k_S_'] #daudet2002
    r.k_S_Mesophyll = 5/24 * DictVal['k_S_'] #daudet2002
...
def SobolTest(myid,weatherX, varNames, varLims, simDuration,condition, testType,directoryN):
    ...
    plant.C_targ = plant.CSTimin
    plant.C_targMesophyll = plant.CSTimin
