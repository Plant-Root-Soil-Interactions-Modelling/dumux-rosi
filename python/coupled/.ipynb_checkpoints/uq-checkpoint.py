...
def weather(simDuration,Tmin,Tmax,specificHumidity,Pair,thetaInit):
    vgSoil = [0.059, 0.45, 0.00644, 1.503, 1]
...
""" Parameters """
def UQR(directoryN,Qmax, simInit):
    ...
    weatherInit = weather(0, Tmin,Tmax,specificHumidity,Pair,thetaInit)
    #simInit = 21
    ...
    while simDuration < simMax: 
        ...
        weatherX = weather(simDuration,Tmin,Tmax,specificHumidity,Pair,thetaInit)
