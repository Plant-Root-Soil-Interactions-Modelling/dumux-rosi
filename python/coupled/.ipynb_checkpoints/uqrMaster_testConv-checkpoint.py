...
def launchUQR(directoryN,simInit,simStartSim, condition,csChoise,spellDuration, simEnd):
    ...
    r = PhloemFluxPython(pl,psiXylInit = -100,ciInit = weatherInit["cs"]*0.5) #XylemFluxPython(pl)#
    ...
    r.gm=0.025#4
    r.usePg4Fw = True
    print(r.Theta_ag,r.DoSun2012,r.limMaxErr,r.alternativeAn)
    r.doWiggle= False;r.DoSun2012=False
    ...
    while simDuration < simMax: 
        ...
        while dtWatertot < dt:
            ...
            print(np.mean(r.psiXyl), np.mean(sx), r.psi_air)
