...
def launchUQR(directoryN,simInit,simStartSim, condition,csChoise,spellDuration, simEnd):
    ...
    r.gm=0.01
    r.usePg4Fw = True
    #print(r.doWiggle,r.DoSun2012,r.limMaxErr)
...
if __name__ == '__main__':
    ...
    #simEnd = str(28)
    directoryN = "/"+os.path.basename(__file__)[:-3]+"/"+simInit+"to"+spellStart+"to"+spellEnd+"to"+simEnd+condition+"oldThetaS/"
