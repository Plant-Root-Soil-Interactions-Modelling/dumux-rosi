    ...
    while simDuration < simMax: 
        ...
        while dtWatertot < dt:
            ...
            if dynamic_soil:
                ...
                Q_Exudmax_i0 = Q_Exudmax_i[0:]
                Q_Exud_i0 = Q_Exud_i[0:]
                
                #print('Q_Exud_i0',np.where((Q_Exudmax_i0 > 0)&(Q_Exud_i0 == 0))[0])
                #Q_Exud_i0[np.where((Q_Exudmax_i0 > 0)&(Q_Exud_i0 <= 0))[0]] = min(Q_Exud_i0[np.where(Q_Exud_i0 == 0)[0]])
                ...
                compute3DSource(s, 1/24/60, [fluxesSoil.copy(),soil_mass_fluxes.copy()])
...
if __name__ == '__main__':
    ...
    directoryN = "/" + scenario + sys.argv[3] + "Control/"
