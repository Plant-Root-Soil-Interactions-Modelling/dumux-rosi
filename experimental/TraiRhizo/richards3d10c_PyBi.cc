...
std::vector<std::vector<double>> getFluxOrSource_10c(
	Richards10<RichardsNCSPProblem, RichardsNCSPAssembler, RichardsNCSPLinearSolver, 3> s, 
	bool doGetSource) 
{
...
int main(int argc, char** argv) //try
{
	...
	auto s = Richards10<RichardsNCSPProblem, RichardsNCSPAssembler, RichardsNCSPLinearSolver, 3>();
