...
cd $HOME/CPBTobias/dumux/dumux-rosi/experimental/fixedPointIter2/scripts 

source $HOME/cpbenv/bin/activate
#export NUMEXPR_MAX_THREADS=${SLURM_CPUS_PER_TASK}
#export OMP_NUM_THREADS=${SLURM_CPUS_PER_TASK}
DUMUX_NUM_THREADS=1 mpirun -n 150 python3 mainTillage.py $1 $2 $3
