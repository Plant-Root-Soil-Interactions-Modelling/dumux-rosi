...
def init_conductivities__(r, TairC:float = 20):
    #mg/cm3
    hPa2cm = 1.0197
...
def init_conductivities(r, age_dependent:bool = False):
    ...
    kx_const_ = 4.32e-2  #4.32e-4  # [cm3/day], Maiz, couvreur et al
    kr_const_  =6.37e-5 #1.73e-5  # [1/day], Maiz, couvreur et al
    ...
    if True:
        ...
        kr0 = np.array([[-1e4, 1.e-9], [0., 1.e-9], [0, 1.14e-03], [2, 1.09e-03], [4, 1.03e-03], [6, 9.83e-05], [8, 9.35e-05], [10, 8.90e-05], [12, 8.47e-05], [14, 8.06e-05], [16, 7.67e-05], [18, 7.30e-05], [20, 6.95e-05], [22, 6.62e-05], [24, 6.30e-05], [26, 5.99e-05], [28, 5.70e-05], [30, 5.43e-05], [32, 5.17e-05]])
        kr1 = np.array([[-1e4, 1.e-9], [0., 1.e-9], [0, 4.11e-03], [1, 3.89e-03], [2, 3.67e-03], [3, 3.47e-03], [4, 3.28e-03], [5, 3.10e-03], [6, 2.93e-05], [7, 2.77e-05], [8, 2.62e-05], [9, 2.48e-05], [10, 2.34e-05], [11, 2.21e-05], [12, 2.09e-05], [13, 1.98e-05], [14, 1.87e-05], [15, 1.77e-05], [16, 1.67e-05], [17, 1.58e-05]])

    # range from couvreur
    kx0 = np.array([[0, 6.74e-04], [2, 7.48e-04], [4, 8.30e-04], [6, 9.21e-04], [8, 1.02e-03], [10, 1.13e-03], [12, 1.26e-03], [14, 1.40e-03], [16, 1.55e-03], [18, 1.72e-03], [20, 1.91e-01], [22, 2.12e-01], [24, 2.35e-01], [26, 2.61e-01], [28, 2.90e-01], [30, 3.21e-01], [32, 3.57e-01]])
