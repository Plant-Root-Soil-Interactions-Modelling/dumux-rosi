...
scenario = 'loam_2_exu_withdecay_withsorption'
...
print('diff',max(abs( exud_in -  exud_out[:len(x_sim)]  )))
print('diff',max(abs( exud_in -  df['Exud_tot'].loc[:].values[:len(x_sim)]  )))
print('diff',max(abs( exud_in - df['Exud_ads'].loc[:].values[:len(x_sim)] - df['Exud_liq'].loc[:].values[:len(x_sim)] )))
print('diff',max(abs( exud_in + df['Exud_decay'].loc[:].values[:len(x_sim)] - df['Exud_ads'].loc[:].values[:len(x_sim)] - df['Exud_liq'].loc[:].values[:len(x_sim)] )))
print('diff',max(abs( exud_in  - df['Exud_ads'].loc[:].values[:len(x_sim)] - df['Exud_liq'].loc[:].values[:len(x_sim)] )))
...
plt.plot(x_sim, df['Exud_tot'].loc[:].values[:len(x_sim)],  label = 'Exud_tot')
...
plt.plot(x_sim, - df['Exud_decay'].loc[:].values[:len(x_sim)],  label = 'Exud_decay')
