...
from rosi_richards_cyl import RichardsCylFoamAna as RichardsNCCylFoam
...
from rosi_richards import RichardsSP as RichardsNCSP
...
def create_soil_model(initsim, simMax, soilTextureAndShape, results_dir , soil_, sorption_type,diffusion, 
    ...
    if sorption_type == 'low': 
        sorp = 0
    elif sorption_type == 'medium': 
        sorp = 1
...
def setupOther(s, soil_type, initsim, simMax,soilTextureAndShape):
    ...
    s.totC3dInit = np.array(s.getTotCContent()).sum() # mol    
