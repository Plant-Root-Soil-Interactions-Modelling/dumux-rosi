...
print("\n",[0.,0.,0.])
print(s.pick_([0.,0.,0.]))
print(s.pickCell([0.,0.,0.]))

print("\n",[-0.1,-0.1,-0.1])
print(s.pick_([-0.1,-0.1,-0.1]))
print(s.pickCell([-0.1,-0.1,-0.1]))

print("\n",[-1.01,5.01,-20.01])
print(s.pick_([-1.01,5.01,-20.01]))
print(s.pickCell([-1.01,5.01,-20.01]))
...
print("\n",[-1.01,5.01,-40.01])
print(s.pick_([-1.01,5.01,-40.01]))
print(s.pickCell([-1.01,5.01,-40.01]))

print("\n",[-1.01,6.01,-20.01])
print(s.pick_([-1.01,6.01,-20.01]))
print(s.pickCell([-1.01,6.01,-20.01]))