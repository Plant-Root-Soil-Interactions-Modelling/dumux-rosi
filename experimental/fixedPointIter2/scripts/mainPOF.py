...
def XcGrowth(initsim, simMax,paramIndx_,spellData): 
    ...
    path = "../inputDataPOF/" #"../../../../CPlantBox/modelparameter/structural/plant/"
    
    if doOld:
        xml_name = "Triticum_aestivum_test_2021_old.xml"  # root growth model parameter fileroot growth model parameter file
    else:
        xml_name = "Triticum_aestivum_test_2021_pof.xml" #"Triticum_aestivum_test_2021_simple.xml"#  # root growth model parameter fileroot growth model parameter file
    ...
    minIter = 2 # empirical minimum number of loop to reduce error
    ...
    perirhizalModel.diff1d3dCurrant_rel_lim = np.inf
    perirhizalModel.maxdiff1d3dCurrant_rel_lim = np.inf
    ...
    while rs_age <= simMax:
        ...
        if (rank == 0) and (not static_plant) :
            ...
            perirhizalModel.ms.simulate(dtgrowth, verbose = False)
        ...
        while keepGoing:
            ...
            if perirhizalModel.doPhloemFlow:
                #phloemData.Q_Exud_i *= 1e2
                #phloemData.Q_Exud_i_seg *= 1e2
            ...
            keepGoing = False #perirhizalModel.n_iter < minIter # (failedLoop & (perirhizalModel.n_iter < perirhizalModel.k_iter))
