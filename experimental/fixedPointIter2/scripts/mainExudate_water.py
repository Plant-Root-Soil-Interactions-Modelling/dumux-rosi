...
sys.path.append("../inputDataExudate_anaWater/");
sys.path.append("../inputDataExudate_anaWater/data/");
...
def XcGrowth(scenarioData): 
    ...
    doPhloemFlow = False
    doExudation = False #prescribed exudation for every root segment 
    ...
    while rs_age < simMax:
        ...
        if (len(_maxDiff1d3dCW_relbefore)>2):
...
if __name__ == "__main__":
    ...
    scenarioData = {'soil_type': args.soil_type}
