...
def start_jobs(jobs):
    ...
    for job in jobs:
        ...
        soil_type = job
        job_name = soil_type[0]+"_wateronly"
        print(job_name)
        ...
        with open(job_file, 'w') as fh:
            ...
            fh.writelines("#SBATCH --ntasks=50\n")
            ...
            fh.writelines("#SBATCH --mail-user=m.landl@fz-juelich.de\n")
            ...
            fh.writelines("mpiexec -n 1 python3 mainExudate_flowonly.py {:s}".format(soil_type[0]))
...
def make_list():
    ...
    print("Creating", len(soil_type), "simulations")
    print()
