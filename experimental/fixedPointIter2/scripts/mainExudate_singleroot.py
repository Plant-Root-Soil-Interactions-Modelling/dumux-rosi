...
if __name__ == "__main__":
    ...
    #mpiexec -n 1 python3 mainExudate_singleroot.py loam high 100 0
    #mpiexec -n 1 python3 mainExudate_singleroot.py loam medium 100 0
    #mpiexec -n 1 python3 mainExudate_singleroot.py loam low 100 0