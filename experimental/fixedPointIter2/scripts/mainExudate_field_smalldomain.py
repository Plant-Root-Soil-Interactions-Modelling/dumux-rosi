...
sys.path.append("../inputDataExudate_smalldomain/");
sys.path.append("../inputDataExudate_smalldomain/data/");
...
def XcGrowth(scenarioData): 
    ...
    results_dir="./results_field_smalldomain/"+soil_type+'_diffusion'+diffusion+"_sorption"+sorption_type+"/"
    ...
    perirhizalModel.doExudation = doExudation
...
if __name__ == "__main__":
    ...
    #mpiexec -n 1 python3 mainExudate_field_smalldomain.py loam low low
    #mpiexec -n 1 python3 mainExudate_field_smalldomain.py loam medium low
    #mpiexec -n 1 python3 mainExudate_field_smalldomain.py loam high low