...
def start_jobs(jobs):
    ...
    for job in jobs:
        ...
        soil_type, res, simInit, simMax, exudate, sorption = job
        job_name = soil_type + "_" + res + "_"+ simInit + "_"+ simMax +"_" + exudate+"_"+sorption
        print(job_name)
        ...
        with open(job_file, 'w') as fh:
            ...
            fh.writelines("mpiexec -n 1 python3 mainExudate.py {:s} {:s} {:s} {:s} {:s} {:s}".format(soil_type, res, simInit, simMax, exudate, sorption))
