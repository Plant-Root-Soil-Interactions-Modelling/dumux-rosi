...
#include "richardsproblem_periodic.hh" // the problem class. Defines some TypeTag types and includes its spatialparams.hh class
#include "properties_periodic.hh" // the property system related stuff (to pass types, used instead of polymorphism)
#include "properties_nocoupling_periodic.hh" // dummy types for replacing the coupling types
