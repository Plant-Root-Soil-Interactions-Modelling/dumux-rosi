...
# result (Figure 4a)
for i in range(0, 3):
    s_, p_, z_ = read1D_vtp_data("benchmark1d_3a-0000" + str(i + 1) + ".vtp", False)
    h_ = vg.pa2head(p_)
...
# result (Figure 4b)
for i in range(0, 3):
    s_, p_, z_ = read1D_vtp_data("benchmark1d_3b-0000" + str(i + 1) + ".vtp", False)
    h_ = vg.pa2head(p_)
...
# result (Figure 4c)
for i in range(0, 3):
    s_, p_, z_ = read1D_vtp_data("benchmark1d_3c-0000" + str(i + 1) + ".vtp", False)
    h_ = vg.pa2head(p_)
