 ...
 *****************************************************************************/
#ifndef DUMUX_RICHARDS_NC_PARAMETERS_HH
#define DUMUX_RICHARDS_NC_PARAMETERS_HH
...
class RichardsNCParams : public FVSpatialParams<FVGridGeometry, Scalar, RichardsNCParams<FVGridGeometry, Scalar>>
{
public:
    ...
    RichardsNCParams(std::shared_ptr<const FVGridGeometry> fvGridGeometry)
    : FVSpatialParams<FVGridGeometry, Scalar, RichardsNCParams<FVGridGeometry, Scalar>>(fvGridGeometry)
    {
