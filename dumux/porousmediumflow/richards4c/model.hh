...
#ifndef DUMUX_RICHARDS4C_MODEL_HH
#define DUMUX_RICHARDS4C_MODEL_HH
...
#include <dumux/material/solidsystems/solidphase2c.hh>
...
struct Richards4CVolumeVariablesTraits
{
...
namespace TTag {
struct Richards4C { using InheritsFrom = std::tuple<PorousMediumFlow>; };
struct Richards4CNI { using InheritsFrom = std::tuple<Richards4C>; };
} // end namespace TTag
//////////////////////////////////////////////////////////////////
// Property tags
//////////////////////////////////////////////////////////////////
...
struct BaseModelTraits<TypeTag, TTag::Richards4C>
{
private:
    using FluidSystem = GetPropType<TypeTag, Properties::FluidSystem>;
    using SolidSystem = GetPropType<TypeTag, Properties::SolidSystem>;
public:
    using type = Richards4CModelTraits<FluidSystem::numComponents, getPropValue<TypeTag, Properties::UseMoles>(), 
											SolidSystem::numComponents,getPropValue<TypeTag, Properties::ReplaceCompEqIdx>()>;
};
template<class TypeTag>
struct ModelTraits<TypeTag, TTag::Richards4C> { using type = GetPropType<TypeTag, Properties::BaseModelTraits>; };

//! Define that per default mole fractions are used in the balance equations
template<class TypeTag>
struct UseMoles<TypeTag, TTag::Richards4C> { static constexpr bool value = true; };

//! Redefine Fick s law to use moles
template<class TypeTag>
struct MolecularDiffusionType<TypeTag, TTag::Richards4C> 
{ 
...
template<class TypeTag>
struct LocalResidual<TypeTag, TTag::Richards4C> { using type = CompositionalLocalResidual<TypeTag>; };

//! We set the replaceCompIdx to 0, i.e. the first equation is substituted with
//! the total mass balance, i.e. the phase balance
template<class TypeTag>
struct ReplaceCompEqIdx<TypeTag, TTag::Richards4C> { static constexpr int value = 0; };

//! Set the volume variables property
template<class TypeTag>
struct VolumeVariables<TypeTag, TTag::Richards4C>
{
private:
    ...
    using NCTraits = Richards4CVolumeVariablesTraits<PV, FSY, FST, SSY, SST, PT, MT, DT, EDM>;

public:
    using type = Richards4CVolumeVariables<NCTraits>;
};
 ...
 */
template<class TypeTag>
struct FluidState<TypeTag, TTag::Richards4C>
{
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
    using FluidSystem = GetPropType<TypeTag, Properties::FluidSystem>;
...
template<class TypeTag>
struct SolidState<TypeTag, TTag::Richards4C>
{
private:
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
    using SolidSystem = GetPropType<TypeTag, Properties::SolidSystem>;
...
template<class TypeTag>
struct SolidSystem<TypeTag, TTag::Richards4C>
{
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
    using InertComponent = Components::Soil<Scalar>;
    //using type = SolidSystems::InertSolidPhase<Scalar, InertComponent>;
	using type = SolidSystems::SolidPhaseTwoC<Scalar,
...
template<class TypeTag>
struct IOFields<TypeTag, TTag::Richards4C> { using type = RichardsNCIOFields; };

//! The model after Millington (1961) is used for the effective diffusivity
template<class TypeTag>
struct EffectiveDiffusivityModel<TypeTag, TTag::Richards4C> { using type = DiffusivityMillingtonQuirk<GetPropType<TypeTag, Properties::Scalar>>; };

//! average is used as default model to compute the effective thermal heat conductivity
template<class TypeTag>
struct ThermalConductivityModel<TypeTag, TTag::Richards4CNI> { using type = ThermalConductivityAverage<GetPropType<TypeTag, Properties::Scalar>>; };
...
template<class TypeTag>
struct ModelTraits<TypeTag, TTag::Richards4CNI>
{
private:
...
//! Set the volume variables property
template<class TypeTag>
struct VolumeVariables<TypeTag, TTag::Richards4CNI>
{
private:
    using PV = GetPropType<TypeTag, Properties::PrimaryVariables>;
    using FSY = GetPropType<TypeTag, Properties::FluidSystem>;
    ...
    using DT = GetPropType<TypeTag, Properties::MolecularDiffusionType>;
    using EDM = GetPropType<TypeTag, Properties::EffectiveDiffusivityModel>;
    using BaseTraits = Richards4CVolumeVariablesTraits<PV, FSY, FST, SSY, SST, PT, MT, DT, EDM>;
...
public:
    using type = Richards4CVolumeVariables<NCNITraits<BaseTraits, ETCM>>;
};
