...
{
    //! Phase indices
    static constexpr int phaseIdx = 0; //!< phase index

    //! primary variable indices
    static constexpr int pressureIdx = 0; //!< pressure
    static constexpr int massOrMoleFracIdx = 1; //!< massOrMoleFracIdx
    ...
    static constexpr int transportEqIdx = 1; //!< transport equation index
};
