...
#ifndef DUMUX_RICHARDS10C_MODEL_CYL_HH
#define DUMUX_RICHARDS10C_MODEL_CYL_HH
...
public:
    using type = Richards10CVolumeVariables<Traits>;
};
...
template<class TypeTag>
struct EnableWaterDiffusionInAir<TypeTag, TTag::Richards10C> { static constexpr bool value = false; };
...
//template<class TypeTag>
//struct EffectiveDiffusivityModel<TypeTag, TTag::Richards10C> { using type = DiffusivityConstantTortuosity<GetPropType<TypeTag, Properties::Scalar>>; };
