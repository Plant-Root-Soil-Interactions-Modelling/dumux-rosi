...
#ifndef DUMUX_RICHARDS5C_MODEL_HH
#define DUMUX_RICHARDS5C_MODEL_HH
...
struct Richards5CVolumeVariablesTraits
{
...
template<class TypeTag>
struct MolecularDiffusionType<TypeTag, TTag::Richards5C> 
{ 
...
private:
    ...
    using NCTraits = Richards5CVolumeVariablesTraits<PV, FSY, FST, SSY, SST, PT, MT, DT, EDM>;

public:
    using type = Richards5CVolumeVariables<NCTraits>;
};
...
//! Set the volume variables property
template<class TypeTag>
struct VolumeVariables<TypeTag, TTag::Richards5CNI>
{
private:
    using PV = GetPropType<TypeTag, Properties::PrimaryVariables>;
    using FSY = GetPropType<TypeTag, Properties::FluidSystem>;
    ...
    using DT = GetPropType<TypeTag, Properties::MolecularDiffusionType>;
    using EDM = GetPropType<TypeTag, Properties::EffectiveDiffusivityModel>;
    using BaseTraits = Richards5CVolumeVariablesTraits<PV, FSY, FST, SSY, SST, PT, MT, DT, EDM>;
...
public:
    using type = Richards5CVolumeVariables<NCNITraits<BaseTraits, ETCM>>;
};
