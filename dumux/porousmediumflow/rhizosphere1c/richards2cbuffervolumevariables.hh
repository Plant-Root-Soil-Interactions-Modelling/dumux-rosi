 ...
 */
#ifndef DUMUX_RICHARDS_2C_BUFFER_RADIALLY_SYMMETRIC_VOLUME_VARIABLES_HH
#define DUMUX_RICHARDS_2C_BUFFER_RADIALLY_SYMMETRIC_VOLUME_VARIABLES_HH
 ...
 * volume in the RichardsTwoCBufferRadiallySymmetric model
 */
template <class TypeTag>
class RichardsTwoCBufferRadiallySymmetricVolumeVariables : public ImplicitVolumeVariables<TypeTag>
{
...
public:
                ...
                const bool isOldSol)
    {
        ...
        porousDiffCoeff_=EffectiveDiffusivityModel::effectiveDiffusivity(porosity_,
                                                                     fluidState_.saturation(phaseIdx),
                                                                     diffCoeff_);
                                   ...
                                   FluidState& fluidState)
    {
        ...
        fluidState.setPressure(phaseIdx, problem.spatialParams().outerPressure());

        // saturations
        Scalar pnRef = problem.referencePressure(element, fvGeometry, scvIdx);
        Scalar sw = MaterialLaw::sw(matParams, pnRef - problem.spatialParams().outerPressure());
