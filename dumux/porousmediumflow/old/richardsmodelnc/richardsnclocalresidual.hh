...
class RichardsLocalResidual : public GetPropType<TypeTag, Properties::BaseLocalResidual>
{
    ...
    //static const bool usePH = getPropValue<TypeTag, Properties::UsePH>();
    static const bool useMoles = getPropValue<TypeTag, Properties::UseMoles>();
                               ...
                               const VolumeVariables& volVars) const
    {
        ...
        if(!useMoles) // mass-fraction formulation
        {
        	...
        	storage[transportEqIdx] += volVars.density() *
										...
										(volVars.saturation(liquidPhaseIdx) * volVars.porosity() + volVars.buffer());
        }
