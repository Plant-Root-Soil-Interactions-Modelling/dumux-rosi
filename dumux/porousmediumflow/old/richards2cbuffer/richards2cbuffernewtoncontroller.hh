 ...
 */
#ifndef DUMUX_RICHARDS_2C_BUFFER_NEWTON_CONTROLLER_HH
#define DUMUX_RICHARDS_2C_BUFFER_NEWTON_CONTROLLER_HH
...
class RichardsTwoCBufferNewtonController : public NewtonController<TypeTag>
{
