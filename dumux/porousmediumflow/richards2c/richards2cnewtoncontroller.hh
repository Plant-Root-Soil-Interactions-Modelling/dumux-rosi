 ...
 */
#ifndef DUMUX_RICHARDS_2C_NEWTON_CONTROLLER_HH
#define DUMUX_RICHARDS_2C_NEWTON_CONTROLLER_HH
...
class RichardsTwoCNewtonController : public NewtonController<TypeTag>
{
...
public:
     ...
     * \brief Constructor
     */
    RichardsTwoCNewtonController(const Problem &problem)
        : ParentType(problem)
    {}
