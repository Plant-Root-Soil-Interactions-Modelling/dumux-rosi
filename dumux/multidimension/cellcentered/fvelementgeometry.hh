 ...
 */
#ifndef DUMUX_MULTIDIMENSION_CC_FV_ELEMENTGEOMETRY_HH
#define DUMUX_MULTIDIMENSION_CC_FV_ELEMENTGEOMETRY_HH
...
class MultiDimensionCCFVElementGeometry : public CCFVElementGeometry<TypeTag>
{
    typedef Dumux::CCFVElementGeometry<TypeTag> ParentType;
