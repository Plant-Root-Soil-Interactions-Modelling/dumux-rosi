 ...
 * \brief Base class for the multidimension coupled models
 */
#ifndef DUMUX_MULTIDIMENSION_MODEL_HH
#define DUMUX_MULTIDIMENSION_MODEL_HH

#include <dune/geometry/type.hh>
#include <dune/istl/bvector.hh>

#include <dumux/multidimension/properties.hh>
#include <dumux/multidimension/assembler.hh>
#include <dumux/multidimension/bulklocaljacobian.hh>
#include <dumux/multidimension/lowdimlocaljacobian.hh>
#include <dumux/multidimension/newtoncontroller.hh>
...
class MultiDimensionModel
{
    ...
    MultiDimensionModel(const MultiDimensionModel &);
...
public:
    ...
    void init(Problem &problem)
    {
        ...
        relativeShiftAtDofOnlyWater_ = tree.template get<Scalar>("Newton.RelativeShiftAtDofOnlyWater", false);
    }
                              ...
                              const PrimaryVariableVector &priVars2)
    {
        ...
        for (int j = 0; j < priVars1.size(); ++j)
        {
            ...
            if (relativeShiftAtDofOnlyWater_) break;
        }
        return result;
    }
...
private:
    ...
    bool relativeShiftAtDofOnlyWater_;
