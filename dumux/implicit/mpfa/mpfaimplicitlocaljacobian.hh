 ...
 */
#ifndef DUMUX_MPFA_IMPLICIT_LOCAL_JACOBIAN_HH
#define DUMUX_MPFA_IMPLICIT_LOCAL_JACOBIAN_HH
...
class MpfaImplicitLocalJacobian
{
private:
    ...
    MpfaImplicitLocalJacobian(const MpfaImplicitLocalJacobian &);

public:
    MpfaImplicitLocalJacobian()
    {
