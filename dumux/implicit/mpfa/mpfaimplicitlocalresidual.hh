 ...
 */
#ifndef DUMUX_MPFA_IMPLICIT_LOCAL_RESIDUAL_HH
#define DUMUX_MPFA_IMPLICIT_LOCAL_RESIDUAL_HH
...
class MpfaImplicitLocalResidual
{
private:
    ...
    MpfaImplicitLocalResidual(const MpfaImplicitLocalResidual &);

public:
    MpfaImplicitLocalResidual()
    { }
    ...
    void eval(const Element &element)
    {
        ...
        fvGeometry.update(gridView_(), element, problem_());
