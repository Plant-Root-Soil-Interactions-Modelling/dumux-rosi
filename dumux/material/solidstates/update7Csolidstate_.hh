 ...
 */
#ifndef DUMUX_UPDATE_7CSOLID_VOLUME_FRACTION_HH
#define DUMUX_UPDATE_7CSOLID_VOLUME_FRACTION_HH
...
void update7CSolidstate(const ElemSol& elemSol,
                                const Problem& problem,
                                const Element& element,
                                const Scv& scv,
                                SolidState& solidState,
                                const int solidVolFracOffset, bool useMoles)
{    
	//assert(useMoles, "update3CSolidstate only works if useMoles == true");
