 ...
 */
#ifndef DUMUX_SOLIDSYSTEMS_COMPOSITIONAL_SOLID_PHASE2C_HH
#define DUMUX_SOLIDSYSTEMS_COMPOSITIONAL_SOLID_PHASE2C_HH
 ...
 */
template <class Scalar, class Component1, class Component2>
class SolidPhaseTwoC
{
public:
    using ComponentOne = Component1;
    using ComponentTwo = Component2;
    using MainComponent = Component2;
    ...
    static constexpr int mainCompIdx = 1;
