 ...
 */
#ifndef DUMUX_SOLIDSYSTEMS_COMPOSITIONAL_SOLID_PHASE14C_HH
#define DUMUX_SOLIDSYSTEMS_COMPOSITIONAL_SOLID_PHASE14C_HH
...
template <class Scalar, class Component1, class Component2, class Component3,
			...
			class Component8, class Component9, class Component10, class Component11,
			class Component12, class Component13, class Component14>
class SolidPhaseFourteenC
{
public:
    ...
    using ComponentEight = Component8;
    using ComponentNine = Component9;
    using ComponentTen = Component10;
    using ComponentEleven = Component11;
    using ComponentTwelve = Component12;
    using ComponentThirteen = Component13;
    using ComponentFourteen = Component14;
    using MainComponent = Component14;


    /****************************************
     * Solid phase related static parameters
     ****************************************/
    static constexpr int numComponents = 14;
    static constexpr int numInertComponents = 1;
    static constexpr int mainCompIdx = 13;
    ...
    static constexpr int comp11Idx = 11;
    static constexpr int comp12Idx = 12;
    static constexpr int comp13Idx = 13;
    ...
    static std::string componentName(int compIdx)
    {
        switch (compIdx)
        {
            ...
            case comp7Idx: return ComponentEight::name();
            case comp8Idx: return ComponentNine::name();
            case comp9Idx: return ComponentTen::name();
            case comp10Idx: return ComponentEleven::name();
            case comp11Idx: return ComponentTwelve::name();
            case comp12Idx: return ComponentThirteen::name();
            case comp13Idx: return ComponentFourteen::name();
