 ...
 * \file
 *
 * \brief @copybrief Dumux::FluidSystems::H2OC20H12
 */
#ifndef DUMUX_H2O_C20H12_FLUID_SYSTEM_HH
#define DUMUX_H2O_C20H12_FLUID_SYSTEM_HH

#include <cassert>

#include <dumux/material/components/benzo[a]pyren.hh>
 ...
 *        Benzo[a]pyren \f$(\mathrm{C_20H_12})\f$ for non-equilibrium models.
 *
...
class H2OC20H12
    : public BaseFluidSystem<Scalar, H2OC20H12<Scalar, useComplexRelations> >
{
    typedef H2OC20H12<Scalar, useComplexRelations> ThisType;
    ...
    typedef Dumux::C20H12<Scalar> C20H12;
...
public:
    ...
    static constexpr int C20H12Idx = 1;
                     ...
                     Scalar pressMin, Scalar pressMax, unsigned nPress)
    {
        if (useComplexRelations)
            std::cout << "Using complex H2O-C20H12 fluid system\n";
        else
            std::cout << "Using fast H2O-C20H12 fluid system\n";
                          ...
                          int phaseIdx)
    {
        ...
        Scalar density_ =clH2O*
            ...
            +
            fluidState.moleFraction(phaseIdx, C20H12Idx)*C20H12::molarMass())
                    / sumMoleFrac;;
        return density_;
    }
...
class H2OC20H12FluidSystem
: public FluidSystems::H2OC20H12<typename GET_PROP_TYPE(TypeTag, Scalar),
