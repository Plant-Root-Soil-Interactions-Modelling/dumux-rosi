...
#include <dumux/material/components/anions/citrate.hh>
...
class H2OC6H5O7
    : public BaseFluidSystem<Scalar, H2OC6H5O7<Scalar, useComplexRelations> >
{
    typedef H2OC6H5O7<Scalar, useComplexRelations> ThisType;
    ...
    typedef Dumux::C6H5O7<Scalar> AnionC6H5O7;
...
public:
    ...
    static constexpr int C6H5O7Idx = 1;
    ...
    static std::string componentName(int compIdx)
    {
        switch (compIdx)
        {
            ...
            case C6H5O7Idx: return C6H5O7::name();
        }
                     ...
                     Scalar pressMin, Scalar pressMax, unsigned nPress)
    {
        if (useComplexRelations)
            std::cout << "Using complex H2O-C6H5O7 fluid system\n";
        else
            std::cout << "Using fast H2O-C6H5O7 fluid system\n";
...
class H2OC6H5O7FluidSystem
: public FluidSystems::H2OC6H5O7<typename GET_PROP_TYPE(TypeTag, Scalar),
