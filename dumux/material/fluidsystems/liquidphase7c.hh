 ...
 * \brief @copybrief Dumux::FluidSystems::LiquidPhaseSevenC
 */
...
template <class Scalar, class MainComponent, class SecondComponent, class ThirdComponent,
			...
			class Policy = liquidp7cDefaultPolicy<>>
class LiquidPhaseSevenC
: public Base<Scalar, LiquidPhaseSevenC<Scalar, MainComponent, SecondComponent, ThirdComponent,
			FourthComponent, FifthComponent, SixthComponent,  SeventhComponent> >
{
    using ThisType = LiquidPhaseSevenC<Scalar, MainComponent, SecondComponent, ThirdComponent,
					FourthComponent, FifthComponent, SixthComponent,  SeventhComponent, Policy>;
...
public:
    ...
    static constexpr int numComponents = 7; //!< Number of components in the fluid system
    ...
    */
    ...
    { 
		...
		switch(compIdx)
		{
			...
			default:
			{
				DUNE_THROW(Dune::InvalidStateException, "liquidphase7c::componentName: compIdx "<<compIdx<<" not recognised");
			}				
		}		
    ...
    {  
		...
		switch(compIdx)
		{
			...
			default:
			{
				DUNE_THROW(Dune::InvalidStateException, "liquidphase7c::molarMass: compIdx "<<compIdx<<" not recognised");
			}
		}		
		return molarMass_; 
	}
                          ...
                          const int phaseIdx = 0)
    {
		...
		// assume pure water
            ...
            {
				DUNE_THROW(Dune::InvalidStateException, "liquidphase7c::density: not useH2ODensityAsLiquidMixtureDensity");
			}
