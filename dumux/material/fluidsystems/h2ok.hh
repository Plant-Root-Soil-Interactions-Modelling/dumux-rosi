 ...
 */
#ifndef DUMUX_H2O_K_FLUID_SYSTEM_HH
#define DUMUX_H2O_K_FLUID_SYSTEM_HH

#include <cassert>

//#include <dumux/material/idealgas.hh>

#include <dumux/material/components/cations/k.hh>
...
class H2OK
    : public BaseFluidSystem<Scalar, H2OK<Scalar, useComplexRelations> >
{
    typedef H2OK<Scalar, useComplexRelations> ThisType;
    ...
    typedef Dumux::K<Scalar> CationK;
...
public:
                     ...
                     Scalar pressMin, Scalar pressMax, unsigned nPress)
    {
        if (useComplexRelations)
            std::cout << "Using complex H2O-K fluid system\n";
        else
            std::cout << "Using fast H2O-K fluid system\n";
...
class H2OKFluidSystem
: public FluidSystems::H2OK<typename GET_PROP_TYPE(TypeTag, Scalar),
