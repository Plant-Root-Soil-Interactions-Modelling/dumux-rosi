...
class ABA
: public Components::Base<Scalar, ABA<Scalar> >
, public Components::Gas<Scalar, ABA<Scalar> >
{
...
public:
    ...
    /*!
     * \brief The molar mass in \f$\mathrm{[kg/mol]}\f$ of abscisic acid.
     */
    static constexpr Scalar molarMass()
    { return 2.6432e-1;}

    /*!
     * \brief Returns the critical temperature \f$\mathrm{[K]}\f$ of abscisic acid
     */
    static Scalar criticalTemperature()
    { return 126.192; /* [K] */ }

    /*!
     * \brief Returns the critical pressure \f$\mathrm{[Pa]}\f$ of abscisic acid
     */
    static Scalar criticalPressure()
    { return 3.39858e6; /* [N/m^2] */ }

    /*!
     * \brief Returns the temperature \f$\mathrm{[K]}\f$ at abscisic acid triple point.
     */
    static Scalar tripleTemperature()
    { return 63.151; /* [K] */ }

    /*!
     * \brief Returns the pressure \f$\mathrm{[Pa]}\f$ at abscisic acid triple point.
     */
    static Scalar triplePressure()
    { return 12.523e3; /* [N/m^2] */ }

    /*!
     * \brief The vapor pressure in \f$\mathrm{[Pa]}\f$ of abscisic acid
    ...
    static Scalar vaporPressure(Scalar T)
    {
        ...
        if (T < tripleTemperature())
            return 0; // ABA is solid: We don't take sublimation into
                      // account
    ...
    /*!
     *  \brief The molar density of \f$abscisic acid\f$ in \f$\mathrm{[mol/m^3]}\f$ at a given pressure and temperature.
     *
     * \param temperature temperature of component in \f$\mathrm{[K]}\f$
     * \param pressure pressure of component in \f$\mathrm{[Pa]}\f$
     *
