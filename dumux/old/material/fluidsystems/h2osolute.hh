...
//#include <dumux/material/components/solute.hh>
...
class H2OSOLUTE
    : public BaseFluidSystem<typename GET_PROP_TYPE(TypeTag, Scalar), H2OSOLUTE<TypeTag> >
{
    typedef H2OSOLUTE<TypeTag> ThisType;
    typedef BaseFluidSystem<typename GET_PROP_TYPE(TypeTag, Scalar), ThisType> Base;
    using Scalar = typename GET_PROP_TYPE(TypeTag, Scalar);
    // convenience typedefs
    //typedef Dumux::IdealGas<Scalar> IdealGas;
    //typedef Dumux::H2O<Scalar> IapwsH2O;
    //typedef Dumux::TabulatedComponent<Scalar, IapwsH2O > TabulatedH2O;
    //typedef Dumux::SOLUTE<ThisType, Scalar> SOLUTE;
...
public:
    ...
    static std::string componentName(int compIdx)
    {
        switch (compIdx)
        {
            ...
            case SoluteIdx: return GET_RUNTIME_PARAM_FROM_GROUP(TypeTag, std::string, Solute, Name).c_str();
        }
    ...
    static Scalar molarMass(int compIdx)
    {
        static const Scalar M[] = {
            H2O::molarMass(),
            GET_RUNTIME_PARAM_FROM_GROUP(TypeTag, Scalar, Solute, MolarMass),
        };
   ...
   /****************************************
                     ...
                     Scalar pressMin, Scalar pressMax, unsigned nPress)
    {
        ...
        //    std::cout << "Using complex H2O-SOLUTE fluid system\n";
        //else
        //    std::cout << "Using fast H2O-SOLUTE fluid system\n";
//
        //if (H2O::isTabulated) {
...
////
        ...
        //    +
        //    fluidState.moleFraction(phaseIdx, SoluteIdx)*GET_RUNTIME_PARAM_FROM_GROUP(TypeTag, Scalar, Solute, MolarMass))
        //            / sumMoleFrac;;
        //return density_;
    }
    ...
    static Scalar binaryDiffusionCoefficient(const FluidState &fluidState,
                                             ...
                                             int compJIdx)
    {
        return GET_RUNTIME_PARAM_FROM_GROUP(TypeTag, Scalar, Solute, liquidDiffCoeff);
    }
};
...
// */
//template<class TypeTag>
//class H2OSOLUTEFluidSystem
//: public FluidSystems::H2OSOLUTE<typename GET_PROP_TYPE(TypeTag, Scalar),
