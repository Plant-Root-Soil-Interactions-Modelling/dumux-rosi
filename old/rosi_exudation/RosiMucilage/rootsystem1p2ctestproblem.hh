...
#if HAVE_UMFPACK
SET_TYPE_PROP(RootsystemOnePTwoCTestProblem, LinearSolver, ILU0BiCGSTABBackend<TypeTag>);//change the type of linear solver at 24.08.17
#endif
...
//        sourceValues[transportEqIdx] = (AdvValue + DiffValue)*source.quadratureWeight()*source.integrationElement();
    ...
    void addOutputVtkFields()
    {
        ...
        this->resultWriter().attachDofData(rootAge, "rootAge", isBox);
    }
