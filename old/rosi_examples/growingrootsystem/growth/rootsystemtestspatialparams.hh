...
#include <dumux/porousmediumflow/1d/rootsystem/spatialparamsGrowth.hh>
...
class RootsystemTestSpatialParams : public RootsystemSpatialParamsGrowth<TypeTag>
{
    typedef RootsystemSpatialParamsGrowth<TypeTag> ParentType;
