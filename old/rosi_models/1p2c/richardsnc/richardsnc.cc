...
#include "richardsncproblem.hh" // the problem class. Defines some TypeTag types and includes its spatialparams.hh class
#include "propertiesnc.hh" // the property system related stuff (to pass types, used instead of polymorphism)
#include "properties_ncnocoupling.hh" // dummy types for replacing the coupling types
...
int main(int argc, char** argv) try
{
    ...
    auto problem = std::make_shared<RichardsNCProblem<TypeTag>>(fvGridGeometry);
