''' Plots from simulations in cluster '''
...
with open("test_actual_transpiration.txt", 'r') as f:  # benchmarkC12c_actual_transpiration. or benchmarkC12bc_actual_transpiration
...
# Plot collar transpiration, chemical concentration & pressure
